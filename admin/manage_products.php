     ...
     <div class="animated fadeIn">
          <div class="row">
               <div class="col-lg-12">
                    ...
                    <div class="form-group">
                         <label for="categories" class="form-control-label">Product Meta_title</label>
                         <textarea name="meta_title" placeholder="Enter Product Meta_title" class="form-control" > <?php echo $meta_title ?></textarea>
                    </div>
                    <div class="form-group">
                         <label for="categories" class=" form-control-label">Product Meta_description</label>
                         <textarea name="meta_desc" placeholder="Enter Product Meta_description" class="form-control" ><?php echo $meta_desc ?></textarea>
                    </div>
                    <div class="form-group">
                         <label for="categories" class=" form-control-label">Product Meta_keyword</label>
                         <textarea name="meta_keyword" placeholder="Enter Product Meta_keyword" class="form-control"><?php echo $meta_keyword ?></textarea>
                    </div>
